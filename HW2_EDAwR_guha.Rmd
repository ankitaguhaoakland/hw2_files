...
The number of variables in the data frame county_MI is one less than the dataframe county_df. And since, county_MI is a subset of the data frame county_df, therefore the number of observations is also less. 
